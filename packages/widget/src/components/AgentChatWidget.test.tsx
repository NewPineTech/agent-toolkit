...
describe('AgentChatWidget — typewriter integration', () => {
  ...
  beforeEach(() => {
    ...
    localStorage.clear();
    configureWidget({ apiUrl: 'http://test' });
  });
  ...
  it('input stays disabled while typewriter is animating after server response completes', async () => {
    ...
    const longContent = 'The quick brown fox jumps over the lazy dog. Here is some additional padding text.';
  ...
  it('does not re-animate last message after close and reopen', async () => {
    ...
    const bubbleBtn = screen.getByRole('button', { name: 'Close chat', expanded: true });
