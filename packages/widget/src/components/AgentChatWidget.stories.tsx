...
const meta = {
  ...
  argTypes: {
    ...
    greeting: {
      control: "text",
      description: "Large welcome greeting (supports \\n for line breaks)",
    },
    botName: {
      control: "text",
      description: "Bot display name used in welcome card",
    },
    suggestions: {
      control: "object",
      description: "Quick-reply suggestion strings",
    },
    theme: { control: "object", description: "Visual theme overrides" },
    user: { control: "object", description: "End-user identity for session" },
    autoScroll: {
      control: "boolean",
      description: "Auto-scroll message list while assistant is typing",
    },
    onError: {
      action: "onError",
...
export const Default: Story = {
  args: {
    ...
    botAvatar: React.createElement("img", {
      src: "https://ai-hr.pinetech.vn/logo-128.png",
      alt: "Bot",
